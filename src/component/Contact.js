...
const Contact = () => {
  return (
    <>
      <div className="Contact-container p-5 flex justify-center w-[100%]">
        <div className="form mt-7">
          ...
          <div className="buttons-react">
            <div className="btns flex items-center h-[13vh]">
              <button className="hover:underline underline-offset-1 duration-150 ease-in-out text-white"><NavLink to="/Home">Go Back Home</NavLink></button>
